...
class httpClient(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, vpc, **kwargs) -> None:
        ...
        user_data.add_commands('sudo yum -y update', 
                               'sudo yum install -y curl httpd-tools')
        ...
        self.http_client_sg = ec2.SecurityGroup(self, 'http-client-sg', 
                                                vpc=vpc, 
                                                allow_all_outbound=True,
                                                security_group_name='http-client-sg')
        self.http_client_sg.add_ingress_rule(peer=ec2.Peer.ipv4(cidr), 
                                             connection=ec2.Port.all_traffic(), 
                                             description='Allow Inbound Connection from VPC')
        security_group = self.http_client_sg
        ...
        role = iam.Role(self, 'http-client-role', 
        ...
        self.http_client = ec2.Instance(self, 'ec2', 
