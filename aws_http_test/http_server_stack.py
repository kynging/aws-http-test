...
class httpServer(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, vpc, **kwargs) -> None:
        ...
        self.http_server_sg = ec2.SecurityGroup(self, 'http-server-sg', 
                                                       vpc=vpc, 
                                                       allow_all_outbound=True,
                                                       security_group_name='http-server-sg')
        self.http_server_sg.add_ingress_rule(peer=ec2.Peer.ipv4('0.0.0.0/0'), 
                                                    connection=ec2.Port.tcp(80), 
                                                    description='Allow Inbound http Connection')
        self.http_server_sg.add_ingress_rule(peer=ec2.Peer.ipv4(cidr), 
        ...
        role = iam.Role(self, 'http-server-role', 
        ...
        self.http_server = ec2.Instance(self, 'ec2', 
